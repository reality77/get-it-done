...
defineEmits<{
  (e: 'change', tab: 'today' | 'week' | 'backlog' | 'checklists'): void
}>()
</script>
...
<template>
  ...
  >
    ...
    >
      ...
      <span class="text-[10px] font-medium leading-none">Backlog</span>
    </button>
    ...
    >
      ...
      <span class="text-[10px] font-medium leading-none">Checklists</span>
    </button>
  </nav>
</template>
